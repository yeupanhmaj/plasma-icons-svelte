<script lang="ts">
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <path style="fill:#f4a93c;stroke-linecap:square;stroke-width:2" id="rect4176" d="M 5 4 L 5 5 L 3 5 L 3 18 L 19 18 L 19 5 L 17 5 L 17 4 L 12 4 L 12 5 L 10 5 L 10 4 L 5 4 z M 6 5 L 9 5 L 9 6 L 13 6 L 13 5 L 16 5 L 16 6 L 18 6 L 18 17 L 4 17 L 4 6 L 6 6 L 6 5 z " transform="matrix(1 0 0 1 326 534.3622)"/>
 </g>
		</svg>
 ...
 <g fill-rule="evenodd">
  ...
  <path fill="#9b6e03" color="#4d4d4d" d="m24 25v2h-3v16h22v-16h-3v-2h-5v2h-6v-2zm1 1h3v2h8v-2h3v2h3v14h-20v-14h3z"/>
 </g>
		</svg>
	{/if}
