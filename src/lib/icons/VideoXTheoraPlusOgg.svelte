<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path color-interpolation-filters="linearRGB" color="#000000" image-rendering="auto" color-rendering="auto" d="m2 1038.36v12h12v-12zm3 1h6v4h-6zm-2 1h1v1h-1zm9 0h1v1h-1zm-9 3.5h1v1h-1zm9 0h1v1h-1zm-7 1.5h6v4h-6zm-2 2h1v1h-1zm9 0h1v1h-1z" color-interpolation="sRGB" text-rendering="auto" fill="#f9d24c" shape-rendering="auto" transform="translate(0-1036.36)"/>
		</svg>
