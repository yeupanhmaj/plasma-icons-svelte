<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#16907d" d="m5 2v3h-3v1h3v4h-3v1h3v3h1v-3h4v3h1v-3h3v-1h-3v-4h3v-1h-3v-3h-1v3h-4v-3zm1 4h4v4h-4z"/>
		</svg>
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <rect width="1" x="333" y="537.36218" height="16" style="fill:#04896a;stroke-width:2" id="rect5552"/>
  <rect width="1" x="340" y="537.36218" height="16" style="fill:#04896a;stroke-width:2" id="rect5552-2"/>
  <rect width="1" x="541.36218" y="-345" height="16" style="fill:#04896a;stroke-width:2" id="rect5552-1" transform="matrix(0 1 -1 0 0 0)"/>
  <rect width="1" x="548.36218" y="-345" height="16" style="fill:#04896a;stroke-width:2" id="rect5552-2-5" transform="matrix(0 1 -1 0 0 0)"/>
 </g>
		</svg>
 ...
 <g transform="translate(-384.57-515.8)">
  ...
  <path fill="#127666" d="m397.57 527.8v3h-3v1h3v4h-3v1h3v3h1v-3h4v3h1v-3h3v-1h-3v-4h3v-1h-3v-3h-1v3h-4v-3zm1 4h4v4h-4z"/>
 </g>
		</svg>
	{:else}
		<svg
