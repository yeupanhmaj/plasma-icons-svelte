<script lang="ts">
	...
	const numericSize = $derived(
		typeof size === 'number' ? size : parseInt(String(size), 10) || 16
	);
</script>
    ...
    <linearGradient id="c" x1="3.99976" x2="3.63492" y1="5" y2="14.1916" gradientUnits="userSpaceOnUse">
        <stop stop-color="#538094" offset="0"/>
        <stop stop-color="#136b2f" offset="1"/>
    </linearGradient>
    <linearGradient id="d" x1="2.8" x2="2.3756" y1="5" y2="14.1804" gradientUnits="userSpaceOnUse">
        <stop stop-color="#6599af" offset="0"/>
        <stop stop-color="#1da848" offset="1"/>
    </linearGradient>
    <linearGradient id="e" x1="3.7998" x2="3.7998" y1="8.20007" y2="14.2001" gradientUnits="userSpaceOnUse">
        <stop stop-color="#2ecc71" offset="0"/>
        <stop stop-color="#cef829" offset="1"/>
    </linearGradient>
    <linearGradient id="f" x1="3.80029" x2="3.80029" y1="9.80002" y2="14.2" gradientUnits="userSpaceOnUse">
        <stop stop-color="#84fe9f" offset="0"/>
        <stop stop-color="#84fe9f" stop-opacity="0" offset="1"/>
    </linearGradient>
    <linearGradient id="g" x1="7.04737" x2="6.78863" y1="3" y2="14.194" gradientUnits="userSpaceOnUse">
        <stop stop-color="#537594" offset="0"/>
        <stop stop-color="#11686d" offset="1"/>
    </linearGradient>
    <linearGradient id="h" x1="5.99976" x2="5.50155" y1="3.39998" y2="14.1769" gradientUnits="userSpaceOnUse">
        <stop stop-color="#5d8da8" offset="0"/>
        <stop stop-color="#0e957d" offset="1"/>
    </linearGradient>
    <linearGradient id="i" x1="6.99976" x2="6.99976" y1="8.20002" y2="14.2" gradientUnits="userSpaceOnUse">
        <stop stop-color="#3daee9" offset="0"/>
        <stop stop-color="#1cdc9a" offset="1"/>
    </linearGradient>
    <linearGradient id="j" x1="6.99976" x2="6.99976" y1="8.20002" y2="14.2" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="l" x1="11.0004" x2="11.062" y1="3.20007" y2="14.3997" gradientUnits="userSpaceOnUse">
        <stop stop-color="#537594" offset="0"/>
        <stop stop-color="#9a265e" offset="1"/>
    </linearGradient>
    <linearGradient id="m" x1="9.50024" x2="9.50024" y1="2.79245" y2="14" gradientUnits="userSpaceOnUse">
        <stop stop-color="#7998be" stop-opacity=".8" offset="0"/>
        <stop stop-color="#9265a2" offset=".5"/>
        <stop stop-color="#622e2e" offset="1"/>
    </linearGradient>
    <linearGradient id="n" x1="10.9838" x2="10.9838" y1="10.4244" y2="13.5153" gradientUnits="userSpaceOnUse">
        <stop stop-color="#e74c3c" offset="0"/>
        <stop stop-color="#da4453" offset=".5"/>
        <stop stop-color="#9b59b6" offset="1"/>
    </linearGradient>
    <linearGradient id="o" x1="9.00004" x2="9.00004" y1="10.5244" y2="13.0002" gradientUnits="userSpaceOnUse">
        <stop stop-color="#fa8e6c" offset="0"/>
        <stop stop-color="#fa8e6c" stop-opacity="0" offset="1"/>
    </linearGradient>
    <linearGradient id="p" x1="9.3999" x2="12.1999" y1="3.40007" y2="3.40007" gradientUnits="userSpaceOnUse">
        <stop stop-color="#99afd2" offset="0"/>
        <stop stop-color="#6a87ab" offset="1"/>
    </linearGradient>
    <path d="m0 2c0-1.104569.895431-2 2-2h12c1.1046 0 2 .895431 2 2v12c0 1.1046-.8954 2-2 2h-12c-1.104569 0-2-.8954-2-2z" fill="url(#a)"/>
    <path d="m0 11h16v3c0 1.1045-.8954 2-2 2h-12c-1.104569 0-2-.8955-2-2z" fill="url(#b)"/>
    <path d="m0 13v1c0 1.1046.895431 2 2 2h12c1.1046 0 2-.8954 2-2v-1c0 1.1046-.8954 2-2 2h-12c-1.104569 0-2-.8954-2-2z" fill="#3f175a"/>
    <path d="m0 3v-1c0-1.10457.895431-2.00000048 2-2.00000048h12c1.1046 0 2 .89543148 2 2.00000048v1c0-1.10457-.8954-2-2-2h-12c-1.104569 0-2 .89543-2 2z" fill="#43566d"/>
    <path d="m2 5h2.99995l-.00017 8c-.00001.5523-.44772 1-1 1-.55229 0-1.00001-.4477-.99999-1l.00021-6z" fill="url(#c)"/>
    <path d="m4.00024 5h-2.00024l1.00024.5v7.5c0 .5523.44772 1 1 1z" clip-rule="evenodd" fill="url(#d)" fill-rule="evenodd"/>
    <path d="m3 10.0001c.62942-.31468 1.37064-.3148 2 0v2.9999c0 .5523-.44772 1-1 1s-1-.4477-1-1z" fill="url(#e)"/>
    <path d="m4.00034 9.76404c-.34265-.00002-.68531.07867-1.0001.23606l.00007 2c.00002.5523.44774 1 1.00003 1z" clip-rule="evenodd" fill="url(#f)" fill-rule="evenodd"/>
    <path d="m3 12v1c0 .5523.44772 1 1 1s1-.4477 1-1v-1c0 .5523-.44772 1-1 1s-1-.4477-1-1z" fill="#99ad1d"/>
    <path d="m6 3h2v10c0 .5523-.44772 1-1 1s-1-.4477-1-1z" fill="url(#g)"/>
    <path d="m7.00022 4.99995-1-.49995-.00022 8.4997c-.00001.5525.4478 1.0003 1.00022 1.0003z" clip-rule="evenodd" fill="url(#h)" fill-rule="evenodd"/>
    <path d="m6 7.99988 2.00024.5-.00019 4.50002c-.00002.5523-.44774 1-1.00002 1-.5523 0-1.00002-.4477-1.00002-1z" fill="url(#i)"/>
    <path d="m6.99995 8.24988-1-.25-.00019 3.99972c-.00003.5524.44778 1.0003 1.00019 1.0003z" fill="url(#j)"/>
    <path d="m6 11.9999v1c0 .5523.44773 1 1.00002 1 .55228 0 1-.4477 1.00002-1v-1c-.00002.5523-.44774 1-1.00002 1-.55229 0-1.00002-.4477-1.00002-1z" fill="#149b8b"/>
    <path d="m5.5 3h3v1h-3z" fill="url(#k)"/>
    <path d="m10.0002 3h2v4.50002l3 5.50008c0 .5522-.4476.9999-.9999.9999h-6.00011c-.55225 0-.99995-.4477-.99995-.9999l2.99996-5.50008z" fill="url(#l)"/>
    <path d="m11.0002 5.00012-1.0002-.5.0002 2.9999-3.0002 5.50008h4z" clip-rule="evenodd" fill="url(#m)" fill-rule="evenodd"/>
    <path d="m15.0002 13.0001-1.6363-3-5.00005.5-1.36385 2.5z" clip-rule="evenodd" fill="url(#n)" fill-rule="evenodd"/>
    ...
    <linearGradient id="d" x1="15" x2="14.0879" y1="17" y2="39.9789" gradientUnits="userSpaceOnUse">
        <stop stop-color="#538094" offset="0"/>
        <stop stop-color="#136b2f" offset="1"/>
    </linearGradient>
    ...
    <linearGradient id="o" x1="21.619" x2="20.9722" y1="9" y2="36.985" gradientUnits="userSpaceOnUse">
        <stop stop-color="#537594" offset="0"/>
        <stop stop-color="#11686d" offset="1"/>
    </linearGradient>
    <linearGradient id="p" x1="19" x2="17.7545" y1="10" y2="36.9424" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="A" x1="29" x2="28.8459" y1="12" y2="39.9992" gradientUnits="userSpaceOnUse">
        <stop stop-color="#537594" offset="0"/>
        <stop stop-color="#9a265e" offset="1"/>
    </linearGradient>
    ...
    <linearGradient id="C" x1="28.4573" x2="28.4573" y1="30.3839" y2="41.9233" gradientUnits="userSpaceOnUse">
        <stop stop-color="#e74c3c" offset="0"/>
        <stop stop-color="#da4453" offset=".5"/>
        <stop stop-color="#9b59b6" offset="1"/>
    </linearGradient>
    <linearGradient id="D" x1="28.5" x2="28.5" y1="29.8623" y2="39" gradientUnits="userSpaceOnUse">
        <stop stop-color="#fa8e6c" offset="0"/>
        <stop stop-color="#fa8e6c" stop-opacity="0" offset="1"/>
    </linearGradient>
    <linearGradient id="E" x1="21.8125" x2="21.8125" y1="27.4286" y2="31.5" gradientUnits="userSpaceOnUse">
    ...
    <path d="m4 8c0-2.20914 1.79086-4 4-4h32c2.2091 0 4 1.79086 4 4v32c0 2.2091-1.7909 4-4 4h-32c-2.20914 0-4-1.7909-4-4z" fill="url(#a)"/>
    <path d="m4 33h40v7c0 2.2091-1.7909 4-4 4h-32c-2.20914 0-4-1.7909-4-4z" fill="url(#b)"/>
    <path d="m4 39v1c0 2.2091 1.79086 4 4 4h32c2.2091 0 4-1.7909 4-4v-1c0 2.2091-1.7909 4-4 4h-32c-2.20914 0-4-1.7909-4-4z" fill="#3f175a"/>
    <path d="m4 9v-1c0-2.20914 1.79086-4 4-4h32c2.2091 0 4 1.79086 4 4v1c0-2.20914-1.7909-4-4-4h-32c-2.20914 0-4 1.79086-4 4z" fill="#43566d"/>
    <path d="m16.46 43-3.73-3.73 2.27-2.27h1.54l6 6z" fill="url(#c)" opacity=".2"/>
    <path d="m10 17h7v20.5c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5v-18z" fill="url(#d)"/>
    <path d="m14 17h-4l2 1v19.5c0 1.2095.8589 2.2184 2 2.45z" clip-rule="evenodd" fill="url(#e)" fill-rule="evenodd"/>
    <path d="m12 29c1.6503-.3301 3.3497-.3301 5 0v8.5c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5z" fill="url(#f)"/>
    <path d="m12 29.0001c.6609-.1322 1.3297-.2115 2-.2378v10.1877c-.7132-.1448-1.3162-.5932-1.6681-1.2044-.2111-.3667-.3319-.792-.3319-1.2456z" clip-rule="evenodd" fill="url(#h)" fill-rule="evenodd"/>
    <path d="m12 36.5v1c0 1.3807 1.1193 2.5 2.5 2.5s2.5-1.1193 2.5-2.5v-1c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5z" fill="#c0d927"/>
    ...
    <path d="m19 9h5v25.5c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5z" fill="url(#o)"/>
    <path d="m21 11-2-.5v24c0 1.2095.8589 2.2184 2 2.45z" clip-rule="evenodd" fill="url(#p)" fill-rule="evenodd"/>
    <path d="m19 22.5 5 .5v11.5c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5z" fill="url(#q)"/>
    <path d="m21 22.7-2-.2v11c0 .4535.1208.8789.3319 1.2456.3519.6112.9549 1.0596 1.6681 1.2044z" fill="url(#s)"/>
    <path d="m19 33.5v1c0 1.3807 1.1193 2.5 2.5 2.5s2.5-1.1193 2.5-2.5v-1c0 1.3807-1.1193 2.5-2.5 2.5s-2.5-1.1193-2.5-2.5z" fill="#18c2ae"/>
    ...
    <path d="m18.29 39.71 20.71-2.71 4.2842 4.2842c-.7227 1.0371-1.9242 1.7158-3.2841 1.7158h-18.4201z" fill="url(#z)"/>
    <path d="m30.9999 12h-5v10.2859l-7.455 12.78c-.3569.6118-.5449 1.3073-.5449 2.0155v1.9186c0 .5523.4477 1 1 1h19c.5523 0 1-.4477 1-1v-1.9186c0-.7082-.188-1.4037-.5449-2.0155l-7.4552-12.7804z" clip-rule="evenodd" fill="url(#A)" fill-rule="evenodd"/>
    <path d="m25.9999 13.5v8.7859l-7.455 12.78c-.3569.6118-.5449 1.3073-.5449 2.0155v1.9186c0 .5523.4477 1 1 1h19c.5523 0 1-.4477 1-1v-1.9186c0-.7082-.188-1.4037-.5449-2.0155l-7.4552-12.7804 7.0001 14.7959v1.9186h-13l2-16.444v-8.556z" fill="url(#B)"/>
    <path d="m20.625 31.5-2.0801 3.566c-.3569.6117-.5449 1.3073-.5449 2.0155v1.9186c0 .5523.4477 1 1 1h19c.5523 0 1-.4477 1-1v-1.9186c0-.7082-.188-1.4038-.5449-2.0155l-3.6551-6.266z" fill="url(#C)"/>
    <path d="m18 38.0001v1c0 .5523.4477 1 1 1h19c.5523 0 1-.4477 1-1v-1c0 .5523-.4477 1-1 1h-19c-.5523 0-1-.4477-1-1z" fill="#9f357b"/>
    <path d="m34.1414 28.9254 3.6665 7.7498c.1265.2674.1921.5596.1921.8554v.4694l-13 1 1.0376-8.531-5.4126 1.031-2.0801 3.5658c-.3569.6118-.5449 1.3073-.5449 2.0155v.9187c0 .5523.4477 1 1 1h6l13.0108-.0001c.5473-.0057.9892-.4512.9892-.9999v-.9187c0-.7082-.188-1.4037-.5448-2.0154l-3.6552-6.266z" fill="url(#D)"/>
