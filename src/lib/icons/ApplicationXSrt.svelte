<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#6c7a89" d="m2 1038.36v8h3v-7h3v2h3v-3h-8zm1 1h1v1h-1zm6 0h1v1h-1zm-6 2h1v2h-1zm3 1v6l2 2v-2h6v-6zm1 1h6v4h-6zm-4 1h1v1h-1z" transform="translate(0-1036.36)"/>
		</svg>
