<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#35bedc" d="m2 1038.36v12h12v-12zm3 1h6v4h-6zm-2 1h1v1h-1zm9 0h1v1h-1zm-9 3.5h1v1h-1zm9 0h1v1h-1zm-7 1.5h6v4h-6zm-2 2h1v1h-1zm9 0h1v1h-1z" transform="translate(0-1036.36)"/>
		</svg>
	{:else if numericSize <= 27}
		<svg
			...
			{...restProps}
		>
			<sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="640" inkscape:window-height="480" id="namedview11" showgrid="false" inkscape:zoom="2.8846743" inkscape:cx="6.2182252" inkscape:cy="18.870275" inkscape:current-layer="layer1"/>
  <defs id="defs3871">
 ...
 <g fill="#ffffff">
  <path opacity=".75" d="M32 28A11 11 0 0 0 21 39 11 11 0 0 0 32 50 11 11 0 0 0 43 39 11 11 0 0 0 32 28m.14453.95117a10 10 0 0 1 10 10 10 10 0 0 1 -10 10 10 10 0 0 1 -10 -10 10 10 0 0 1 10 -10"/>
  <g color-rendering="auto" color-interpolation-filters="linearRGB" shape-rendering="auto" image-rendering="auto" text-rendering="auto" color-interpolation="sRGB" color="#000000">
