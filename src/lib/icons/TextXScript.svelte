<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#6c7a89" color="#000000" stroke-width=".1" d="m3.715 3l-.715.695 2.639 2.797-2.621 2.813.715.695 2.943-3.162.324-.346-.324-.348zm3.285 9v1h6v-1z"/>
		</svg>
 ...
 <g id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <path style="shape-rendering:auto;color-interpolation-filters:linearRGB;fill:#6c7a89;image-rendering:auto;text-rendering:auto;color:#000000;fill-rule:evenodd;color-rendering:auto;color-interpolation:sRGB" id="path4313" d="M 4.765625 4 L 4 4.6054688 L 8.7070312 10 L 4 15.394531 L 4.765625 16 L 10 10 L 4.765625 4 z M 10 17 L 10 18 L 18 18 L 18 17 L 10 17 z " transform="matrix(1 0 0 1 326 534.3622)"/>
 </g>
		</svg>
