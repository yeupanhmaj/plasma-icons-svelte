<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m0 2v12h6v-1h-5v-10h13v3.1016c0.48581-0.053102 1.011-0.083036 1.5723-0.09375-0.02369-0.0034169-0.047601-0.0078125-0.072266-0.0078125h-0.5v-4h-15zm2 2v8h4v-2l2-1c1.0235-1.0235 2.0483-1.7835 3.3398-2.2832l-0.33984-2.7168h-9z" fill="currentColor"/>
	...
	{:else if numericSize <= 27}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m1 5v12h7v-1h-6v-10h17v2.0156c0.31583-0.010037 0.6458-0.015625 1-0.015625v-3h-17-2zm2 2v8h5v-2l4-2c1.3732-1.3732 2.2756-2.2747 4.3242-2.7051l-0.32422-1.2949h-13z" fill="currentColor"/>
	...
	{:else}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m3 10v12h12v-1h-11v-10h23v3.8203c0.61515-0.021426 1.2788-0.023839 2-0.003906v-0.81641c0-0.554-0.446-1-1-1v-3h-25zm2 2v8h10l3-1c1.3174-1.3174 2.2018-3.068 5.7949-3.8242l-0.79492-3.1758h-18z" fill="currentColor"/>
