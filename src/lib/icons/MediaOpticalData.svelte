<script lang="ts">
	...
	{#if numericSize <= 19}
       ...
       d="M 8 2 C 4.6862915 2 2 4.6862915 2 8 C 2 11.313708 4.6862915 14 8 14 L 8 13 C 5.2385763 13 3 10.761424 3 8 C 3 5.2385763 5.2385763 3 8 3 C 10.761424 3 13 5.2385763 13 8 L 14 8 C 14 4.6862915 11.313708 2 8 2 z M 8 6 C 6.8954305 6 6 6.8954305 6 8 C 6 9.1045695 6.8954305 10 8 10 L 8 9 C 7.4477153 9 7 8.5522847 7 8 C 7 7.4477153 7.4477153 7 8 7 C 8.5522847 7 9 7.4477153 9 8 L 10 8 C 10 6.8954305 9.1045695 6 8 6 z M 9 9 L 9 14 L 11 14 L 12 13 L 13 12 L 13 9 L 9 9 z M 10 10 L 12 10 L 12 12 L 11 12 L 11 13 L 10 13 L 10 10 z "
	...
	{:else if numericSize <= 43}
		...
		>
			<path
       style="fill:currentColor;fill-opacity:1;stroke:none" 
       d="M 11 3 A 8 8 0 0 0 3 11 A 8 8 0 0 0 11 19 A 8 8 0 0 0 12 18.929688 L 12 17.921875 A 7 7 0 0 1 11 18 A 7 7 0 0 1 4 11 A 7 7 0 0 1 11 4 A 7 7 0 0 1 18 11 L 19 11 A 8 8 0 0 0 11 3 z M 11 5 C 7.676 5 5 7.676 5 11 L 8 11 C 8 9.338 9.338 8 11 8 L 11 5 z M 11 9 A 2 2 0 0 0 9 11 A 2 2 0 0 0 11 13 L 11 12 A 1 1 0 0 1 10 11 A 1 1 0 0 1 11 10 A 1 1 0 0 1 12 11 L 13 11 A 2 2 0 0 0 11 9 z M 13 12 L 13 19 L 16 19 L 18 17 L 18 12 L 13 12 z M 14 13 L 17 13 L 17 17 L 16 17 L 16 18 L 14 18 L 14 13 z "
       id="rect4119" 
       class="ColorScheme-Text"/>
		</svg>
	{:else}
  ...
  <linearGradient inkscape:collect="always" xlink:href="#linearGradient4351" id="linearGradient4215" x1="29.734833" x2="47.734833" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1.1111111 0 0 1.1111111 381.53272 -618.94577)"/>
  <linearGradient inkscape:collect="always" id="linearGradient4372-2" xlink:href="#linearGradient4227" y1="522.91602" y2="533.68524" x1="407.55716" gradientUnits="userSpaceOnUse" x2="418.3273" gradientTransform="matrix(1.2998888 0 0 1.3 -488.77899 -669.79083)"/>
  ...
  <linearGradient inkscape:collect="always" xlink:href="#linearGradient4300" id="linearGradient5250" y1="545.79071" y2="533.79071" x2="0" gradientUnits="userSpaceOnUse"/>
 </defs>
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -376.57144 -491.79797)">
  ...
  <circle cx="424.57144" cy="507.79797" style="fill:url(#linearGradient4215);stroke-linecap:round" id="path4207" r="10"/>
  <path inkscape:connector-curvature="0" style="fill:url(#linearGradient4372-2);opacity:0.2;fill-rule:evenodd" id="path4364-0" d="m 52.999987,19.000023 -3,3 -7,0 15.000013,15 c 0,0 -1.3e-5,-22 0,-22 l -5.000013,-5 z" transform="matrix(1 0 0 1 376.57144 491.79797)"/>
  <path inkscape:label="Capa 1" inkscape:connector-curvature="0" style="fill:url(#linearGradient5250);fill-rule:evenodd" id="rect4140" d="m 3,2 0,12 6,0 1,0 3,-3 0,-1 0,-8 -10,0 z m 1,1 8,0 0,7 -3,0 0,3 -5,0 0,-10 z" transform="matrix(1 0 0 1 416.57144 499.79797)"/>
 </g>
		</svg>
	{/if}
