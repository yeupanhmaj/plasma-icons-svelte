<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path color-interpolation-filters="linearRGB" color="#000000" image-rendering="auto" color-rendering="auto" d="m2 1038.36v12h12v-12zm3 1h6v4h-6zm-2 1h1v1h-1zm9 0h1v1h-1zm-9 3.5h1v1h-1zm9 0h1v1h-1zm-7 1.5h6v4h-6zm-2 2h1v1h-1zm9 0h1v1h-1z" color-interpolation="sRGB" text-rendering="auto" fill="#209ae7" shape-rendering="auto" transform="translate(0-1036.36)"/>
		</svg>
	{:else if numericSize <= 27}
		<svg
			...
			{...restProps}
		>
			<sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="640" inkscape:window-height="480" id="namedview11" showgrid="false" inkscape:zoom="4.0795455" inkscape:cx="-13.982712" inkscape:cy="-14.71892" inkscape:current-layer="layer1"/>
  <defs id="defs3871">
    ...
    <linearGradient y2="336.36221" x2="58" y1="392.36221" x1="58" gradientTransform="matrix(1,0,0,0.75815667,-58,-254.25709)" gradientUnits="userSpaceOnUse" id="linearGradient4270-1" xlink:href="#linearGradient6251" inkscape:collect="always"/>
  </defs>
 ...
 <g color-rendering="auto" color-interpolation-filters="linearRGB" shape-rendering="auto" image-rendering="auto" text-rendering="auto" color-interpolation="sRGB" color="#000000" transform="translate(-384.57-515.8)">
  <path fill="#209ae7" d="m414.57 545.8h-28v-22h28v7z"/>
