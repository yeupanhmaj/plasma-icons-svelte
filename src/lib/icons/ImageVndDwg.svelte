<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#3a539b" fill-rule="evenodd" d="m7 2v2h2v-2zm-.131 2.357l-1.98.531.818.818 1.293-.348v-1zm2.131 0v1l3.057.82-3.057.818v7h.131l4.861-1.303.008.002v-7.04l-.008.002-4.861-1.303zm-5.689.953l-1.311.352v7.338l6 1v-7l-4.391-.732.52-.139zm9.689 1.652v4.432l-3-.805v-2.822zm-3 4.664l2.057.551-2.057.553z"/>
		</svg>
