...
>
  ...
  <linearGradient id="e" y1="24.827" x1="10.281" y2="7.355" x2="3.574" gradientUnits="userSpaceOnUse" gradientTransform="matrix(-.96593.25882-.25882-.96593 53.39 40.971)">
 ...
 <g fill-rule="evenodd">
  <path opacity=".2" fill="url(#h)" d="m37 20l-.227.34.227.66c-.091.091-.197.18-.293.27a13 13 0 0 1 -.15039 6.095703 13 13 0 0 1 -7.410157 8.572266l.447.963.615 2.902 1.959 2.441c1.251-.558 2.44-1.242 3.551-2.043l-1.139-2.922c.999-.795 1.905-1.7 2.701-2.697l2.914 1.135c.802-1.111 1.488-2.301 2.047-3.553l-2.438-1.953c.471-1.188.805-2.426.998-3.689l.842-.129z"/>
