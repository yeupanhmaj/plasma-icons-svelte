<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#cf74e0" color="#000000" stroke-width=".1" d="m9.09 2l-3.146 11.74.967.26 3.146-11.74zm-3.805 2l-2.961 3.145-.324.348.324.346 2.943 3.162.715-.695-2.621-2.813 2.639-2.797zm5.43 0l-.715.695 2.639 2.797-2.621 2.813.715.695 2.943-3.162.324-.346-.324-.348z"/>
		</svg>
	{:else if numericSize <= 27}
		<svg
			...
			{...restProps}
		>
			<sodipodi:namedview pagecolor="#ffffff" bordercolor="#666666" borderopacity="1" objecttolerance="10" gridtolerance="10" guidetolerance="10" inkscape:pageopacity="0" inkscape:pageshadow="2" inkscape:window-width="709" inkscape:window-height="480" id="namedview41" showgrid="false" inkscape:zoom="10.727273" inkscape:cx="11" inkscape:cy="11" inkscape:window-x="0" inkscape:window-y="0" inkscape:window-maximized="0" inkscape:current-layer="layer1"/>
  <defs id="defs3871">
  ...
  <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
    <g inkscape:label="Capa 1" style="fill:#cf74e0;fill-opacity:1" id="layer1-1" transform="matrix(1 0 0 1 -225.28572 -73.28571)">
      <path inkscape:connector-curvature="0" style="color:#000000;fill:#cf74e0;fill-opacity:1" id="path3454" d="m 563.78571,610.64791 -4,15.75384 1,0.24616 4,-15.75385 -1,-0.24615 z"/>
      <path inkscape:connector-curvature="0" style="color:#000000;fill:#cf74e0;fill-opacity:1" id="path4224" d="m 566.03107,613.64791 -0.74534,0.70967 3.66459,4.29032 -3.66459,4.29033 0.74534,0.70968 3.97515,-4.64516 0.27951,-0.35485 -0.27951,-0.35483 -3.97515,-4.64516 z"/>
      <path inkscape:connector-curvature="0" style="color:#000000;fill:#cf74e0;fill-opacity:1" id="path4224-7" d="m 558.54037,613.64791 0.74534,0.70967 -3.66459,4.29032 3.66459,4.29033 -0.74534,0.70968 -3.97515,-4.64516 -0.27951,-0.35485 0.27951,-0.35483 3.97515,-4.64516 z"/>
    </g>
  </g>
		</svg>
