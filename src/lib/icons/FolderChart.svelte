<script lang="ts">
 ...
 <path 
     ...
     d="m 20,12 v 10 h 1 V 12 Z m -6,3 v 7 h 1 v -7 z m 3,3 v 4 h 1 v -4 z m -6,2 v 2 h 1 v -2 z m -1,3 v 1 h 12 v -1 z"
     class="ColorScheme-Text"
     />
		</svg>
 ...
 <path 
     style="fill:currentColor;fill-opacity:0.6;stroke:none"  
     d="m 39,25 v 20 h 2 V 25 Z m -12,8 v 12 h 2 V 33 Z m 4,4 v 8 h 2 v -8 z m 4,3 v 5 h 2 v -5 z m -12,2 v 3 h 2 v -3 z m -2,4 v 1 h 22 v -1 z"
     class="ColorScheme-Text"
     />
		</svg>
	{:else}
