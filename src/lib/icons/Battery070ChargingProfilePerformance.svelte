<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m0 2v12h6v-1h-5v-10h13v3.1016c0.48581-0.053102 1.011-0.083036 1.5723-0.09375-0.02369-0.0034169-0.047601-0.0078125-0.072266-0.0078125h-0.5v-4h-15zm2 2v8h4v-2l2-1c0.47937-0.47937 0.95989-0.8992 1.4668-1.2637l-0.4668-3.7363h-7z" fill="currentColor"/>
    ...
    <path class="ColorScheme-Text" d="m15.994 7c-3.9941 0-5.9941 2-6.9941 3l-2 1 1 1 0.00391 1.5 1.5 1.5h1.4961l1 1 1-2c1-1 3-3 2.9941-7zm-0.99609 1c-2e-3 2-1.998 6-4.998 6l-1-1c1e-7 -3 3.9992-5 5.998-5zm-2.248 1.5c-0.41421 0-0.75 0.33579-0.75 0.75s0.33579 0.75 0.75 0.75 0.75-0.33579 0.75-0.75-0.33579-0.75-0.75-0.75zm-5.5499 4.5c-0.2 2-0.2 2 1.8 1.8z" color="currentColor" fill="currentColor"/>
		</svg>
	{:else if numericSize <= 27}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m1 5v12h7v-1h-6v-10h17v2.0156c0.31583-0.010037 0.6458-0.015625 1-0.015625v-3h-16-3zm2 2v8h5v-2l4-2c0.5852-0.5852 1.0858-1.0821 1.625-1.4961l-0.625-2.5039h-10z" fill="currentColor"/>
	...
	{:else}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-Text" d="m3 10v12h12v-1h-11v-10h23v3.8203c0.61515-0.021426 1.2788-0.023839 2-0.003906v-0.81641c0-0.554-0.446-1-1-1v-3h-25zm2 2v8h10l3-1c0.69622-0.69622 1.2716-1.5145 2.1895-2.2422l-1.1895-4.7578h-14z" fill="currentColor"/>
