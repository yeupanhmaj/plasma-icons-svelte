<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#8e44ad" d="m2 2v12h12v-12zm6 1h5v1h-5zm-5 2h3v8h-3zm4 0h6v8h-6z"/>
		</svg>
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <path style="fill:#8e44ad" id="rect4089" d="M 3 3 L 3 19 L 8 19 L 9 19 L 19 19 L 19 3 L 9 3 L 8 3 L 3 3 z M 11 4 L 18 4 L 18 6 L 11 6 L 11 4 z M 4 7 L 8 7 L 8 18 L 4 18 L 4 7 z M 9 7 L 18 7 L 18 18 L 9 18 L 9 7 z " transform="matrix(1 0 0 1 326 534.3622)"/>
 </g>
		</svg>
    ...
    <g id="g33" fill-rule="evenodd">
        <path id="path27" d="m54 17l-14-14v14z" fill="url(#b)" />
        <path id="path29" d="m40 17l14 14v-14z" fill="url(#c)" opacity=".2" />
        <path id="path31" d="m21 22v22h22v-22zm11 1h10v3h-10zm-10 4h5v16h-5zm6 0h14v16h-14z" fill="#e8d9eb" />
    </g>
		</svg>
	{/if}
