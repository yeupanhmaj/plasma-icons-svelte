...
>
	<defs>
        <linearGradient id="c" x2="0" y1="543.8" y2="503.8" gradientTransform="matrix(1.125,0,0,1,-433.64001,-499.79998)" gradientUnits="userSpaceOnUse">
    ...
    <rect transform="rotate(-90)" x="-42" y="6" width="1" height="36" fill="#737b81" stroke-opacity=".55" stroke-width="2.6563132"/>
    ...
    <g transform="rotate(90,51.500002,-2.499998)" stroke-width=".1">
