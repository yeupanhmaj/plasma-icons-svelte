<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path color-interpolation-filters="linearRGB" color="#000000" image-rendering="auto" color-rendering="auto" d="m2 2v12h12v-12h-11zm1 1h1.912c.057.16.087.33.088.5 0 .828-.672 1.5-1.5 1.5-.17-.001-.34-.03-.5-.088zm2.947 0h7.05v10h-10v-.783l1.326-1.299 1.408-1.404.564.418 1.102 1.068 2.6-2.398 4 3.891-1-2.492-3-3-2.6 2.6-1.6-1.6-2.801 2.801v-4.854c.164.034.332.052.5.053 1.381 0 2.5-1.119 2.5-2.5-.001-.168-.018-.336-.053-.5" color-interpolation="sRGB" text-rendering="auto" fill="#c4bb1b" shape-rendering="auto"/>
		</svg>
 ...
 <g transform="translate(-384.57-515.8)">
  ...
  <use fill="url(#b)" xlink:href="#c"/>
	...
	{:else}
		...
		>
			<defs>
  <linearGradient id="a" y1="17" x1="40" y2="31" gradientUnits="userSpaceOnUse" x2="54" gradientTransform="translate(6 4)">
   <stop stop-color="#060606"/>
   <stop offset="1" stop-opacity="0"/>
  </linearGradient>
  <linearGradient id="b" y1="392.36" y2="320.48" x2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1 0 0 .84587-34-276.73)">
   <stop stop-color="#ffffff" stop-opacity="0"/>
   <stop offset="1" stop-color="#ffffff" stop-opacity=".2"/>
  </linearGradient>
