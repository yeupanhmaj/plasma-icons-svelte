<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path fill="#16907d" color="#000000" stroke-width="1.4" d="m2 2v1h6v-1zm0 3v1h12v-1zm0 3v1h6v-1zm0 2v1h12v-1zm0 3v1h9v-1z"/>
		</svg>
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <rect width="8" x="329" y="537.36218" height="1.00002" style="fill:#16907d" id="rect4279"/>
  <rect width="16" x="329" y="541.36218" height="1" style="fill:#16907d" id="rect4281"/>
  <rect width="16" x="329" y="548.36218" height="1" style="fill:#16907d" id="rect4283"/>
  <rect width="8" x="329" y="545.36218" height="1" style="fill:#16907d" id="rect4285"/>
  <rect width="12" x="329" y="552.36218" height="0.999983" style="fill:#16907d" id="rect4287"/>
 </g>
		</svg>
 ...
 <g transform="translate(-384.57-515.8)">
  ...
  <path fill="#127666" color="#000000" stroke-width="1.4" d="m394.57 527.8v1h6v-1zm0 3v1h12v-1zm0 3v1h6v-1zm0 2v1h12v-1zm0 3v1h9v-1z"/>
 </g>
		</svg>
	{:else}
		<svg
 ...
 <path fill="#127666" d="m21 22v1h22v-1zm0 3v1h22v-1zm0 3v1h11v-1zm0 4v1h22v-1zm0 3v1h19v-1zm0 2v1h11v-1zm0 3v1h22v-1zm0 3v1h16v-1z"/>
		</svg>
	{/if}
