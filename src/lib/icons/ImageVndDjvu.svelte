<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<g fill="#f9b425" color="#4d4d4d" transform="translate(-421.71-531.79)">
  ...
  <g id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
    <path style="opacity:1;fill:#f9b425;fill-opacity:1;stroke:none" d="m 329,537.3622 0,2 0,1 0,13 1,0 8,0 2,0 2,0 2,0 1,0 0,-3 0,-2 0,-9 0,-2 -1,0 0,1 -2,0 0,-1 -1,0 0,1 -2,0 0,-1 -1,0 0,1 -2,0 0,-1 -1,0 0,1 -2,0 0,-1 -1,0 0,1 -2,0 0,-1 -1,0 z m 1,3 14,0 0,1 0,1 0,1 0,1 0,5 0,2 0,1 -1,0 -2,0 -3,0 -8,0 0,-8 0,-1 0,-1 0,-1 0,-1 z m 2,2 0,1 10,0 0,-1 -10,0 z m 0,3 0,1 6,0 0,-1 -6,0 z m 0,3 0,1 8,0 0,-1 -8,0 z m 8,2 0,1 2,0 0,-1 -2,0 z" id="rect4108" class="ColorScheme-Text"/>
  </g>
		</svg>
