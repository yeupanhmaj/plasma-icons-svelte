<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<g fill="#f27935" color="#4d4d4d" transform="translate(-421.71-531.79)">
 ...
 <g inkscape:label="Capa 1" inkscape:groupmode="layer" id="layer1" transform="matrix(1 0 0 1 -326 -534.3622)">
  <g inkscape:label="Capa 1" style="fill:#f27935" id="layer1-1" transform="matrix(1 0 0 1 -95.71429 8.57146)">
   <path inkscape:connector-curvature="0" style="color:#4d4d4d" id="rect3343" d="m 5,8 0,3 1,0 0,-1 4,0 0,1 1,0 0,-3 -1,0 0,1 L 6,9 6,8 5,8 Z m 6,6 0,3 1,0 0,-1 4,0 0,1 1,0 0,-3 -1,0 0,1 -4,0 0,-1 -1,0 z" transform="matrix(1 0 0 1 421.71429 525.79074)"/>
   <path inkscape:connector-curvature="0" style="color:#4d4d4d" id="rect3370" d="m 6,3 c 0,0 -1,-3e-5 -1,1 l -2,0 0,3 0,11 0,1 16,0 0,-1 0,-11 0,-3 -2,0 C 17,2.99997 16,3 16,3 l -3,0 c 0,0 -1,-3e-5 -1,1 L 10,4 C 10,2.99997 9,3 9,3 L 6,3 Z M 6,4 9,4 9,5 6,5 6,4 Z m 7,0 3,0 0,1 -3,0 0,-1 z M 4,7 18,7 18,18 4,18 4,7 Z" transform="matrix(1 0 0 1 421.71429 525.79074)"/>
  </g>
 </g>
		</svg>
 ...
 <path fill="#fbd2bf" d="m24 22a1 1 0 0 0 -1 1h-2v21h22v-21h-2a1 1 0 0 0 -1 -1h-5a1 1 0 0 0 -1 1h-3a1 1 0 0 0 -1 -1zm0 1h6.449v1H24zm11 0h5v1h-5zm-13 4h20v16h-20zm2 2v5h1v-2h6v2h1v-5h-1v2h-6v-2zm8 7v5.25h1v-2.25h6v2h1v-5h-1v2h-6v-2z"/>
		</svg>
	{/if}
