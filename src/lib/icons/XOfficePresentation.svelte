<script lang="ts">
  ...
  <path inkscape:connector-curvature="0" style="color:#000000;color-interpolation:sRGB;color-interpolation-filters:linearRGB;fill:#ff8b23;color-rendering:auto;image-rendering:auto;shape-rendering:auto;text-rendering:auto;fill-opacity:1" d="M 3,3 3,5 2,5 2,19 20,19 20,5 19,5 19,3 Z M 4,4 18,4 18,5 4,5 Z M 3,6 19,6 19,18 3,18 Z m 5,2 0,8 7,-4 z" id="path4" sodipodi:nodetypes="ccccccccccccccccccccccc"/>
		</svg>
 ...
 <g transform="translate(-384.57-515.8)">
  ...
  <path opacity=".9" color-interpolation-filters="linearRGB" color="#000000" image-rendering="auto" color-rendering="auto" d="m394.57 525.8v2h-1v11h14v-11h-1v-2zm1 1h10v1h-10zm-1 2h12v9h-12zm4 2v5l4.61-2.475z" color-interpolation="sRGB" text-rendering="auto" fill="#ffffff" shape-rendering="auto"/>
