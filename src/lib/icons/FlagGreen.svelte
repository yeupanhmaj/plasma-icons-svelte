<script lang="ts">
  ...
  <path d="m423.71 533.79h1v12h-1z" 
        ...
        />
  <path d="m424.71 533.79l5 1v1l6 2-2 1 2 1-6 1v-1l-5 1z" style="fill:#2ecc71"/>
</g>
		</svg>
	{:else}
		<svg
    ...
    class="ColorScheme-Text"
    />  
 <path d="m4 3v9l5-1 1-.199219v2l9-1.800781-2-1 2-1-9-2.400391v-2l-1-.265625-5-1.333984" style="fill:#43be80"/>
		</svg>
	{/if}
