<script lang="ts">
 ...
 <path 
     ...
     d="m 11,13 v 1 h -1 v 9 h 12 v -9 h -1 v -1 h -4 v 1 h -2 v -1 z m 1,1 h 2 v 1 h 4 v -1 h 2 v 1 h 1 v 7 H 11 v -7 h 1 z"
     class="ColorScheme-Text"
     />
		</svg>
 ...
 <path 
     style="fill:currentColor;fill-opacity:0.6;stroke:none"  
     d="m 24,28 v 2 H 21 V 46 H 43 V 30 h -3 v -2 h -5 v 2 h -6 v -2 z m 1,1 h 3 v 2 h 8 v -2 h 3 v 2 h 3 V 45 H 22 V 31 h 3 z"
     class="ColorScheme-Text"
     />
		</svg>
	{:else}
  ...
  <path
    d="m36 44v5h-3v19h30v-19h-3v-5h-9v5h-6v-5zm1 1h7v5h8v-5h7v5h3v17h-28v-17h3z"
