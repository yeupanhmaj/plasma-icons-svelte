<script lang="ts">
	...
	{#if numericSize <= 19}
		<svg
			...
			{...restProps}
		>
			<path class="ColorScheme-NegativeText" d="m0 2v12h6v-1h-5v-10h13v3.1016c0.48581-0.053102 1.011-0.083036 1.5723-0.09375-0.02369-0.0034169-0.047601-0.0078125-0.072266-0.0078125h-0.5v-4h-15zm2 2v8h2l-1-8h-1z" fill="currentColor"/>
    <path class="ColorScheme-NegativeText" d="m15.994 7c-3.9941 0-5.9941 2-6.9941 3l-2 1 1 1 0.00391 1.5 1.5 1.5h1.4961l1 1 1-2c1-1 3-3 2.9941-7zm-0.99609 1c-2e-3 2-1.998 6-4.998 6l-1-1c1e-7 -3 3.9992-5 5.998-5zm-2.248 1.5c-0.41421 0-0.75 0.33579-0.75 0.75s0.33579 0.75 0.75 0.75 0.75-0.33579 0.75-0.75-0.33579-0.75-0.75-0.75zm-5.5499 4.5c-0.2 2-0.2 2 1.8 1.8z" color="currentColor" fill="currentColor"/>
		</svg>
